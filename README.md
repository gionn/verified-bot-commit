...
[`@gionn-net/verified-bot-commit`](https://www.npmjs.com/package/@gionn-net/verified-bot-commit)
package on npm.

### CLI Usage

```sh
npx --yes @gionn-net/verified-bot-commit \
...
Run `npx @gionn-net/verified-bot-commit --help` to see all available arguments,
